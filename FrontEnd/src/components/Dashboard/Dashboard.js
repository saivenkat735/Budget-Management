    ...
    const fetchDashboardData = async (personId) => {
        try {
            ...
            const [accountsResponse, billsResponse, transactionsResponse] = await Promise.all([
                ...
                axios.get('http://localhost:9007/bills/getbills', {
            ...
            // Calculate financial metrics only from active accounts
            ...
            const fixedExpenses = allBills.reduce((sum, bill) => sum + parseFloat(bill.amount), 0);
